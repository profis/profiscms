...
CREATE TABLE IF NOT EXISTS `pc_auth_groups` (
...
CREATE TABLE IF NOT EXISTS `pc_auth_log` (
...
CREATE TABLE IF NOT EXISTS `pc_auth_permissions` (
...
CREATE TABLE IF NOT EXISTS `pc_auth_users` (
...
CREATE TABLE IF NOT EXISTS `pc_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pc_content_archive` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pc_domains` (
...
CREATE TABLE IF NOT EXISTS `pc_gallery_categories` (
...
CREATE TABLE IF NOT EXISTS `pc_gallery_files` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pc_gallery_files_in_use` (
...
CREATE TABLE IF NOT EXISTS `pc_gallery_thumbnail_types` (
...
CREATE TABLE IF NOT EXISTS `pc_path_index` (
...
CREATE TABLE IF NOT EXISTS `pc_site_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pc_sites` (
...
-- --------------------------------------------------------
-- 
-- Table structure for table `pc_site_users_meta`
-- 

CREATE TABLE IF NOT EXISTS `pc_site_users_meta` (
...
CREATE TABLE IF NOT EXISTS `pc_variables` (
