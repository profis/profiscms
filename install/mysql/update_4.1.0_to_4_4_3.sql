RENAME TABLE `pc_user_groups` TO `pc_auth_groups` ;

RENAME TABLE `pc_users` TO `pc_auth_users` ;
...
ALTER TABLE `pc_auth_users` 
	ADD UNIQUE KEY `username`(`username`) ;

/* Alter table in target */
ALTER TABLE `pc_content_archive` 
