...
<form action="" method="post">
	...
	<table class="table-condensed" cellpadding="0" cellspacing="2" border="0">
		...
		<tr>
			...
			<td class="help muted"><?php echo $t['required']; ?>.</td>
		</tr>
		<tr id="row-db-host">
		...
		<tr id="row-db-port">
			...
			<td class="help muted"><?php echo $t['optional']; ?>. <?php echo $t['db_port_expl']; ?></td>
		</tr>
		<tr id="row-db-name">
			...
			<td class="help muted" id="help-db-name"><?php echo $t['required']; ?>. <?php echo $t['db_name_expl']; ?></td>
		</tr>
		<tr id="row-db-user">
		...
		<tr id="row-db-pass">
			...
			<td class="help muted"><?php echo $t['optional']; ?>. <?php echo $t['db_password_expl']; ?></td>
		</tr>
		<tr id="row-table-prefix">
			...
			<td class="help muted" id="help-db-prefix"><?php echo $t['optional']; ?>. <?php echo $t['db_prefix_expl']; ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="help muted"><?php echo $t['required']; ?>. <?php echo $t['admin_name_expl']; ?></td>
		</tr>
		<tr>
			...
			<td class="help muted"><?php echo $t['required']; ?>. <?php echo $t['admin_pass_expl']; ?></td>
		</tr>
	</table>
	<hr />
	<p class="buttons">
