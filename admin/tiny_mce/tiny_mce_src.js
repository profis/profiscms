...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.DOMUtils', {
		...
		getClasses: function(valid_tags) {
						...
						case 1:
							if (r.selectorText) {
								each(r.selectorText.split(','), function(v) {
									...
									ov = v;
									var tag = v.substring(0, v.indexOf('.'));
									...
									//ProfisCMS
									if (valid_tags && tag) {
										if (typeof valid_tags == 'object') {
											if (valid_tags.has(tag.toLowerCase()) === false) {
												return;
											}
										}
...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton', {
		...
		showMenu : function() {
			...
			e = DOM.get(t.id);
			p2 = DOM.getPos(e);
			PC.dialog.colorpicker.show(p2.x+15, p2.y+16, this);
			return;
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			InsertHorizontalRule : function() {
				selection.setContent('<hr noshade="noshade" size="1" />');
			},
