		...
		init : function(ed, url) {
			...
			each({
				...
				mceTableMergeCells : function(grid) {
					...
					if (!ed.dom.select('td.mceSelected,th.mceSelected').length) {
                                                ...
                                                PC.dialog.mergetablecells.show(callback);
                                                return;
			...
			each({
				mceInsertTable : function(val) {
					var action = (val?val.action:'');
					PC.dialog.tables.show(action, ed);
					return;
					winMan.open({
						url : url + '/table.htm',
				...
				mceTableRowProps : function() {
					PC.dialog.tablerow.show(ed.parents);
					return;
					winMan.open({
						url : url + '/row.htm',
				...
				mceTableCellProps : function() {
					PC.dialog.tablecell.show(ed.parents);
					return;
					winMan.open({
						url : url + '/cell.htm',
