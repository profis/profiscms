	...
	var cfg = {
		...
		tinymceSettings: {
			...
			extended_valid_elements: '@[id|class|style|title|dir<ltr?rtl|lang|xml::lang|onclick|ondblclick|onmousedown|onmouseup|onmouseover|onmousemove|onmouseout|onkeypress|onkeydown|onkeyup],'
				...
				+'input[required|name|type|value|tabindex|maxlength|readonly|size|checked|placeholder|src|data-maxuploadsize|onfocus|onblur|onchange|onselect],'
				+'textarea[rows|cols|required|name|tabindex|readonly|placeholder|onfocus|onblur|onchange|onselect],'
