	...
	var cfg = {
		...
		tinymceSettings: {
			...
			extended_valid_elements: '@[id|class|style|title|dir<ltr?rtl|lang|xml::lang|onclick|ondblclick|onmousedown|onmouseup|onmouseover|onmousemove|onmouseout|onkeypress|onkeydown|onkeyup],'
				...
				+'input[required|name|style|class|type|value|tabindex|maxlength|readonly|size|id|checked|placeholder|src|data-maxuploadsize|onclick|onfocus|onblur|onchange|onselect],'
				+'textarea[rows|cols|required|name|style|class|tabindex|readonly|id|placeholder|onclick|onfocus|onblur|onchange|onselect],'
				+'iframe[width|height|src|frameborder|scrolling|marginheight|marginwidth],fb:like,'
				+'label[for|onclick|onfocus|onblur],'
